                ...
                <div class="card mb-4" style="background: linear-gradient(135deg,#4e73df 0%,#375ad3 100%); border: none;">
                    <div class="card-body py-4 d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            ...
                            <p class="text-white-50 mb-2">Here's a summary of your activity.</p>
                            <span class="badge badge-light text-dark mr-2">
                                <i class="fa fa-building mr-1"></i> {{ optional(auth()->user()->company)->name ?? 'N/A' }}
                            </span>
                            <span class="badge badge-light text-dark">
                                <i class="fa fa-id-badge mr-1"></i> {{ auth()->user()->getRoleNames()->first() ?? 'Member' }}
                            </span>
                        </div>
                        <a href="{{ route('member.short-urls.create') }}" class="btn btn-light mt-3 mt-md-0">
                ...
                <div class="row">
                    <div class="col-lg-6 col-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="{{ route('member.short-urls.index') }}" class="small-box-footer">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">My Recent Short URLs</h3>
                                <a href="{{ route('member.short-urls.index') }}" class="btn btn-sm btn-outline-secondary">View All</a>
                            </div>
                            <div class="card-body p-0">
                                <table class="table table-striped mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center text-muted py-4">You haven't created any short URLs yet.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
