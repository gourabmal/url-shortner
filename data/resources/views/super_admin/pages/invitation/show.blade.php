        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Invite By</th>
                        <td> {{ $invitation->inviter->name ?? 'User #'.$invitation->invited_by }}</td>
                    </tr>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('superadmin.invitations.index') }}"
                ...
                @if($status == 'Expired')
                    ...
                    <form action="{{ route('superadmin.invitations.resend', $invitation) }}"
                          method="POST"
                          class="d-inline">
                        @csrf
