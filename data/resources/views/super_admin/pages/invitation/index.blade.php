                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h3 class="card-title" style="float: right!important;">
                                    <a href="{{ route('superadmin.invitations.create') }}" class="btn btn-success"><i
                                    ...
                                    <tbody>
                                        ...
                                        @forelse($invitations as $invitation)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('superadmin.invitations.show', $invitation) }}"
                                                        class="btn btn-info btn-sm" data-toggle="tooltip"
                                                        data-placement="top" title="View"><i class="fa fa-eye"></i></a>

                                                    @if ($status === 'Expired' || $status === 'Cancelled')
                                                        <form
                                                            action="{{ route('superadmin.invitations.resend', $invitation) }}"
                                                    ...
                                                    <!-- <form
                                                        action="{{ route('superadmin.invitations.destroy', $invitation) }}"
                                                        method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
